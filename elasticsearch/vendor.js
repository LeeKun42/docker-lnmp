...
// Attach a bunch of functions for handling common AJAX events
    ...
    jQuery.extend({
        ...
        ajaxSettings: {
            ...
            global: true,
            type: "GET",
            contentType: "application/json;charset=UTF-8",//application/x-www-form-urlencoded lijun
            processData: true,
            async: true,
            /*
		timeout: 0,
...
// Detect, normalize options and install callbacks for jsonp requests
    jQuery.ajaxPrefilter( "json jsonp", function( s, originalSettings, jqXHR ) {
        ...
        var inspectData = s.contentType === "application/json;charset=UTF-8" && //application/x-www-form-urlencoded lijun
